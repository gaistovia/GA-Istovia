...
(function(){
  ...
  var DEMOS = [
    {
      ...
      techTags: ["HTML5", "CSS3", "JavaScript", "Responsive"],
    ...
    {
      name: "Avantheon Motors — Automotive Demo",
      industry: "Automotive / Car Dealership",
      tag: "Automotive",
      icon: "car",
      description: "Mfano wa website ya kifahari ya dealer wa magari — inventory ya magari, design ya hali ya juu na uzoefu wa premium kwa wateja.",
      techTags: ["HTML5", "CSS3", "JavaScript", "Responsive"],
      image: "https://images.unsplash.com/photo-1621568671104-aa9bcb0c1c70?q=80&w=870&auto=format&fit=crop",
      liveUrl: "https://gaistovia.github.io/avantheon-motors/"
    },
    {
      name: "Kwame Mensah — Landing Page Demo",
      industry: "Personal Brand / Landing Page",
      tag: "Landing Page",
      icon: "bullseye",
      description: "Mfano wa landing page ya kifahari kwa personal brand — design safi, ujumbe wenye nguvu na muundo unaolenga conversions.",
      techTags: ["HTML5", "CSS3", "JavaScript", "Conversion-Focused"],
      image: "https://images.unsplash.com/photo-1590098563831-d28f8c52726b?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      liveUrl: "https://gaistovia.github.io/kwame-mensah/"
    },
    {
      name: "Kesho — Ecommerce Demo",
      industry: "E-commerce / Shoes & Smart Watches",
      tag: "E-commerce",
      icon: "shoe-prints",
      description: "Mfano wa duka la mtandaoni la kifahari — viatu na smart watches, product gallery ya kisasa na uzoefu wa ununuzi ulioboreshwa.",
      techTags: ["HTML5", "CSS3", "JavaScript", "E-commerce UI"],
      image: "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&w=900&q=80",
      liveUrl: "https://gaistovia.github.io/kesho/"
    }
  ...
  function cardHTML(d){
    var tagsHTML = (d.techTags && d.techTags.length)
      ? '<div class="demo-feats">' + d.techTags.map(function(t){ return '<span>' + t + '</span>'; }).join("") + '</div>'
      : "";
    return (
