  ...
  var DEMOS = [
    {
      ...
      image: "assets/images/demo-restaurant-cover.png",
  ...
  function cardHTML(d){
    return (
      '<article class="demo-card" role="listitem">' +
        ...
        '<div class="dc-media">' +
          '<span class="dc-tag"><i class="fas fa-utensils" aria-hidden="true"></i> ' + d.tag + '</span>' +
          '<img src="' + d.image + '" alt="' + d.name + '" loading="lazy" width="640" height="360">' +
        '</div>' +
        '<div class="dc-body">' +
