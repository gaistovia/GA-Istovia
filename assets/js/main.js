...
(function(){
  ...
  /* ---------- preloader: letter-by-letter name reveal + progress ---------- */
  (function(){
    var nameEl = document.getElementById("ldr-name");
    if(nameEl){
    ...
    var fill = document.getElementById("ldr-track-fill");
  ...
  /* ---------- theme toggle (default: dark "Signal" theme — the official brand identity; optional light "Daylight" mode) ---------- */
  (function(){
    var btn = document.getElementById("theme-toggle");
    if(!btn) return;
    var icon = btn.querySelector("i");
    var stored = null;
    try{ stored = window.localStorage ? localStorage.getItem("ga-theme") : null; }catch(e){}
    if(stored === "light"){
    ...
    btn.addEventListener("click", function(){
      ...
      try{ if(window.localStorage) localStorage.setItem("ga-theme", light ? "light" : "dark"); }catch(e){}
    });
  })();
  ...
  /* ---------- hero typewriter (short words only — reserved-height line prevents CLS) ---------- */
  (function(){
    var el = document.getElementById("hero-type");
    if(!el) return;
    var words = ["Digital Growth","Modern Websites","Online Sales","Brand Identity","Smart Systems"];
  ...
  /* ---------- hero parallax (mouse-driven layered depth on the wordmark art) ---------- */
  (function(){
    ...
    hero.addEventListener("mousemove", function(e){
      ...
      if(art){
        art.style.transform = "rotateY(" + (px*6) + "deg) rotateX(" + (py*-6) + "deg)";
      }
    ...
    hero.addEventListener("mouseleave", function(){
      ...
      if(art) art.style.transform = "rotateY(0) rotateX(0)";
    });
  })();
  ...
  (function(){
    var screens = document.querySelectorAll(".demo-screen, .laptop-viewport");
  ...
  /* ---------- character-by-character reveal (hero headline) ---------- */
  (function(){
  ...
  (function(){
    ...
    var dotsHost = document.getElementById("test-dots");
    ...
    function go(i){
      ...
      dotsHost.querySelectorAll(".test-dot").forEach(function(d, idx){
    ...
    if(!reduceMotion){
      var auto = setInterval(function(){ go(cur + 1); }, 6000);
      track.closest(".test-slider").addEventListener("mouseenter", function(){ clearInterval(auto); });
      track.closest(".test-slider").addEventListener("mouseleave", function(){
        auto = setInterval(function(){ go(cur + 1); }, 6000);
      });
    }
  })();
